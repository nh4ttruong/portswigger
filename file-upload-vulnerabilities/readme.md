...
![Thử upload 1.php](race-conditions/error.jpg)
...
![Đổi thành hehe.php.png](race-conditions/changefile.jpg)
...
![Nhấn attack thôi](race-conditions/bypass.jpg)

Ở các request, ta có thể tìm kiếm được bí mật của chú Carlos và submit thôi:
![Submit](race-conditions/solved.jpg)
